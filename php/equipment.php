          ...
          if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
              ...
              echo "<td class='equipment-image'>
                    ...
                    <input type='file' style='display: none;' id='$ph' onchange='previewImage(this, \"photo_" . $row['equipment_id'] . "\", \"inp_" . $row['equipment_id'] . "\");'>
                  </td>";
              ...
              echo "<td><input type='number' name='quantity' value='" . $row["quantity"] . "'>
               ...
               echo "<td><input type='text' name='photo' id='inp_" . $row['equipment_id'] . "' value='" . $row["photo"] . "' ></td>";
